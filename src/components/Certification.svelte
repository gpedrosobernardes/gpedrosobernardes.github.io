<script>
	import { Img, Heading, P, A, Secondary, Hr } from 'flowbite-svelte';

	let { name, platform, date } = $props();

	const platformToImage = {
	    "LinkedIn Learning": "/linkedin.webp",
		"Cisco Networking Academy": "/cisco.webp",
		"DIO": "/dio.webp"
	}
